    ...
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="header ml-[70px] pr-[70px] w-[940px] flex items-center justify-between mt-10">
                ...
                <div class="relative">
                    <a href="{{ route('dashboard.course.course_student.create', $course) }}" class="h-[52px] p-[14px_30px] bg-[#6436F1] rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D]">Add Student</a>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-5 mt-2">
                    @forelse ($students as $student )
                        <div class="student-card w-full flex items-center justify-between p-4 border border-[#EEEEEE] rounded-[20px]">
                            ...
                            <div class="flex items-center gap-[14px]">
                                <p class="p-[6px_10px] rounded-[10px]  bg-slate-500 font-bold text-xs text-white outline-slate-500 outline-dashed outline-[2px] outline-offset-[4px] mr-[6px]">Not Passed</p>
                            </div>
                            @elseif($student->status == 'Not Started')
                            <div class="flex items-center gap-[14px]">
                                <p class="p-[6px_10px] rounded-[10px]  bg-[#FD445E] font-bold text-xs text-white outline-[#FD445E] outline-dashed outline-[2px] outline-offset-[4px] mr-[6px]">Not Started</p>
                            </div>
                            @endif
                        </div>
                    @empty
                        <p>Belum ada siswa pada kelas ini.</p>
                    @endforelse
                </div>
            </div>
        </div>
