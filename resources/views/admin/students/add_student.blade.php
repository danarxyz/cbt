...
<body class="font-poppins text-[#0A090B]">
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
                ...
                <div class="mx-[70px] mt-5">
                    <ul class="flex flex-col gap-2">
                        @foreach ($errors->all() as $error)
                            <li class="p-5 rounded-lg bg-red-700 text-white font-semibold shadow-sm">
                                {{ $error }}
                            </li>
                        @endforeach
                    </ul>
            ...
            <form method='POST' action="{{ route('dashboard.course.course_student.store', $course) }}" id="add-question" class="mx-[70px] mt-[30px] flex flex-col gap-5">
                @csrf
