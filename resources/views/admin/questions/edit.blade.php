    ...
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <form method="POST" action="{{ route('dashboard.course_question.update', $courseQuestion) }}" id="add-question" class="mx-[70px] mt-[30px] flex flex-col gap-5">
                    ...
                    @foreach($courseQuestion->answers as $index => $answer)
                        <div class="flex items-center gap-4">
                            <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                                ...
                                <input type="text" name="answers[]" value="{{ old('answers.'.$index, $answer->answer) }}" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Write better answer option">
                            </div>
                ...
                <button type="submit"  class="w-[500px] h-[52px] p-[14px_20px] bg-[#6436F1] rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center">Save Question 
                </button>
            </form>
        </div>
    </section>
