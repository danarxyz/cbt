        ...
        <div id="sidebar" class="w-[270px] flex flex-col shrink-0 min-h-screen justify-between p-[30px] border-r border-[#EEEEEE] bg-[#FBFBFB]">
            <div class="w-full flex flex-col gap-[30px]">
                ...
                <ul class="flex flex-col gap-3">
                    ...
                    <li>
                        <a href="{{ route('dashboard.course.course_student.index', $course) }}" class="p-[10px_16px] flex items-center gap-[14px] rounded-full h-11 transition-all duration-300 hover:bg-[#2B82FE]">
                            <div>
                ...
                <div class="relative">
                    ...
                    <div class="dropdown-menu absolute hidden right-0 top-[66px] w-[270px] flex flex-col gap-4 p-5 border border-[#EEEEEE] bg-white rounded-[18px] transition-all duration-300 shadow-[0_10px_16px_0_#0A090B0D]">
                        ...
                        <form method="POST" action="{{ route('dashboard.courses.destroy', $course) }}" class="">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="flex gap-[10px] items-center text-[#FD445E]">
                                <div class="w-5 h-5">
